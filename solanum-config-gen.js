export const generateSolanumConfig=function(args) {
    return `/* doc/ircd.conf.example - brief example configuration file
 *
...
serverinfo {
	...
	sid = "001";
	description = "${args.server_description}";
...
auth {
  ...
  password = "kiwi";
  spoof = "webirc.";
  flags = dnsbl_exempt, proxy_exempt, dnsbl_exempt;
};
...
connect "${args.services_hostname}" {
	host = "127.0.0.1";
...
general {
	...
	identify_service = "NickServ@${args.services_hostname}";
...
export default generateSolanumConfig;